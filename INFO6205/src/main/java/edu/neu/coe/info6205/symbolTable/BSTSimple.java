...
//    }
    ...
    public int getDepth(Node x){
        if(x == null) return 0;
        int left = getDepth(x.smaller);
        int right = getDepth(x.larger);
